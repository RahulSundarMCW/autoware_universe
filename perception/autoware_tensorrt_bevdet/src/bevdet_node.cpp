...
void TRTBEVDetNode::startImageSubscription()
{
  ...
  // Use the below for AWSIM as it accepts QoS:BEST EFFORT published by AWSIM

  sub_f_img_.subscribe(this, "~/input/topic_img_f", rclcpp::SensorDataQoS().get_rmw_qos_profile());
  sub_b_img_.subscribe(this, "~/input/topic_img_b", rclcpp::SensorDataQoS().get_rmw_qos_profile());

  sub_fl_img_.subscribe(this, "~/input/topic_img_fl", rclcpp::SensorDataQoS().get_rmw_qos_profile());
  sub_fr_img_.subscribe(this, "~/input/topic_img_fr", rclcpp::SensorDataQoS().get_rmw_qos_profile());

  sub_bl_img_.subscribe(this, "~/input/topic_img_bl", rclcpp::SensorDataQoS().get_rmw_qos_profile());
  sub_br_img_.subscribe(this, "~/input/topic_img_br", rclcpp::SensorDataQoS().get_rmw_qos_profile());
  
  // Use the below for Nuscenes as it accepts QoS:RELIABLE published by Nuscenes
...
void TRTBEVDetNode::startCameraInfoSubscription()
{
  ...
  sub_fl_caminfo_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
    "~/input/topic_img_fl/camera_info", rclcpp::SensorDataQoS(),
  ...
  sub_f_caminfo_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
    "~/input/topic_img_f/camera_info", rclcpp::SensorDataQoS(),
  ...
  sub_fr_caminfo_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
    "~/input/topic_img_fr/camera_info", rclcpp::SensorDataQoS(),
  ...
  sub_bl_caminfo_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
    "~/input/topic_img_bl/camera_info", rclcpp::SensorDataQoS(),
  ...
  sub_b_caminfo_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
    "~/input/topic_img_b/camera_info", rclcpp::SensorDataQoS(),
  ...
  sub_br_caminfo_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
    "~/input/topic_img_br/camera_info", rclcpp::SensorDataQoS(),
...
//This below callback() only accepts messages of BGR8
...
//This below callback() only accepts any type of messages and converts them to bevdet compatible type
